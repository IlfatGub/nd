...
<?php foreach($model as $item): ?>
    ...
    <?php $review = isset($item->type) ? 'help_main_border_active' : 'help_main_border'; //Меняем цвет в зависимотсти от заявки(служебка, звонок)?>
    <?php $review = isset($item->api_login) ? 'help_main_border_user' : $review; //Меняем цвет в зависимотсти от заявки(служебка, звонок)?>
